...
export default function LoginPage() {
  ...
  const handleGoogleLogin = useCallback(async () => {
    ...
    try {
      ...
      // Also store Telegram user ID if available
      if (initDataUser?.id) {
  ...
  return (
    <Page back={true}>
      <div className="tma-page" style={{ display: 'flex', flexDirection: 'column', minHeight: '90vh' }}>
        {/* Hero Section */}
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', paddingTop: 20 }}>
          ...
          <p className="tma-hint" style={{ fontSize: 15, marginBottom: 32 }}>Private Intent Trading on Sui</p>

          {/* Features List */}
          <div className="tma-section" style={{ width: '100%', maxWidth: 340, marginBottom: 24 }}>
            <div className="tma-list-item">
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p className="tma-hint" style={{ fontSize: 13 }}>Sign in with Google OAuth</p>
              </div>
            </div>
            ...
            <div className="tma-list-item">
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p className="tma-hint" style={{ fontSize: 13 }}>Privacy-preserving authentication</p>
              </div>
            </div>
            ...
            <div className="tma-list-item">
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p className="tma-hint" style={{ fontSize: 13 }}>Encrypted intents on DeepBook</p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="tma-google-btn"
            style={{ width: '100%', maxWidth: 340 }}
          >
            {isLoading ? (
              <>
                <div className="tma-spinner-sm" />
                <span>Connecting...</span>
              </>
            ) : (
              <>
                {/* Google Logo */}
                <svg className="tma-google-icon" viewBox="0 0 24 24">
